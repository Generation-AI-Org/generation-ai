    ...
    <div className="flex items-center gap-2 px-4 md:px-6 py-3 overflow-x-auto scrollbar-hide border-b border-[var(--border)] bg-bg">
      ...
      {mode === 'public' ? (
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/auth/signout"
            className="shrink-0 px-4 py-2.5 min-h-[44px] rounded-full text-sm font-medium bg-[var(--border)] text-[var(--text-muted)] hover:bg-red-500/10 hover:text-red-400 transition-all flex items-center gap-2"
            title="Abmelden"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

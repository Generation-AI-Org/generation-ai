  ...
  return (
    <div className="flex items-center gap-2 px-4 md:px-6 py-3 overflow-x-auto scrollbar-hide border-b border-[var(--border)] bg-bg">
      ...
      {mode === 'public' ? (
        <Link
          href="/login"
          className="group shrink-0 px-4 py-2.5 min-h-[44px] rounded-full text-sm font-mono font-bold tracking-wide bg-[var(--accent)] text-[var(--text-on-accent)] shadow-[0_0_12px_var(--accent-glow)] hover:shadow-[0_0_20px_var(--accent-glow)] hover:scale-[1.03] transition-all duration-300 hidden md:flex items-center gap-2"
        >
